...
turtle.write("Te Quiero mucho mi mapache, feliz dia a la mujer mas linda ❤️❤️", align="center", font=("Arial", 24, "bold"))


turtle.penup()
turtle.goto(0, -300)  # Ajusta la posición vertical según sea necesario
turtle.color("white")  # Color del texto
turtle.write("Te extraño", align="center", font=("Arial", 10, "bold"))
